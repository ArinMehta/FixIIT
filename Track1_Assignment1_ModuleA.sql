...
-- -- Error query 3
-- INSERT INTO tickets (title, description, member_id, location_id, category_id, priority, status_id)
-- VALUES ('Bad priority', 'Invalid priority value', 3, 1, 1, 'SuperHigh', 1);
