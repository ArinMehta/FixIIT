...
INSERT INTO ticket_comments (ticket_id, member_id, comment_text, commented_at) VALUES
-- Ticket 1 (Closed) - Supervisor handles closure update (no assignment in your data)
(1, 3,  'Ticket raised: Projector flickers and shuts down.', '2026-01-10 09:00:00'),
(1, 29, 'Acknowledged. Logged and routed to the relevant team.', '2026-01-10 09:10:00'),
(1, 29, 'Update: Issue verified during inspection; resolved and ticket closed.', '2026-01-10 12:30:00'),

-- Ticket 2 (Closed)
(2, 8,  'Ticket raised: Leaky faucet needs repair.', '2026-01-11 10:30:00'),
(2, 29, 'Acknowledged. Scheduled for maintenance round.', '2026-01-11 10:40:00'),
(2, 29, 'Update: Repair completed and leakage stopped. Closing ticket.', '2026-01-11 13:20:00'),

-- Ticket 3 (Closed)
(3, 15,  'Ticket raised: Window latch broken and won’t lock.', '2026-01-12 08:15:00'),
(3, 29, 'Acknowledged. Added to carpentry queue.', '2026-01-12 08:25:00'),
(3, 29, 'Update: Latch replaced/adjusted. Ticket closed.', '2026-01-12 15:10:00'),

-- Ticket 4 (Closed)
(4, 9,  'Ticket raised: No WiFi connectivity in conference room.', '2026-01-13 14:20:00'),
(4, 29, 'Acknowledged. Network team informed.', '2026-01-13 14:30:00'),
(4, 29, 'Update: Access point rebooted and connectivity restored. Closing ticket.', '2026-01-13 18:00:00'),

-- Ticket 5 (Closed)
(5, 14,  'Ticket raised: Gym locker door stuck and cannot open.', '2026-01-14 16:00:00'),
(5, 29, 'Acknowledged. Scheduled for inspection.', '2026-01-14 16:10:00'),
(5, 29, 'Update: Lock mechanism adjusted and locker operational. Ticket closed.', '2026-01-14 17:20:00'),

-- Ticket 6 (Closed)
(6, 4,  'Ticket raised: Lab AC not cooling effectively.', '2026-01-15 11:05:00'),
(6, 29, 'Acknowledged. Logged for AC technician visit.', '2026-01-15 11:15:00'),
(6, 29, 'Update: Cooling restored after checks. Closing ticket.', '2026-01-15 16:00:00'),

-- Ticket 7 (Assigned) - Electrician A (17)
(7, 5,  'Ticket raised: Power outlet sparks when used.', '2026-01-16 09:40:00'),
(7, 29, 'Acknowledged. Assigned to Electrician.', '2026-01-16 09:45:00'),
(7, 17, 'Update: Inspected outlet; isolating circuit and replacing damaged socket.', '2026-01-16 10:30:00'),

-- Ticket 8 (Assigned) - Plumber A (19)
(8, 10, 'Ticket raised: Kitchen drain clogged and backing up.', '2026-01-17 13:10:00'),
(8, 29, 'Acknowledged. Assigned to Plumber.', '2026-01-17 13:15:00'),
(8, 19, 'Update: Clearing blockage and testing flow. Will recheck after peak hours.', '2026-01-17 14:20:00'),

-- Ticket 9 (Assigned) - IT Support A (22)
(9, 9, 'Ticket raised: Network switch keeps rebooting.', '2026-01-18 18:30:00'),
(9, 29, 'Acknowledged. Assigned to IT Support.', '2026-01-18 18:35:00'),
(9, 22, 'Update: Checking logs and applying stable configuration/firmware.', '2026-01-18 19:10:00'),

-- Ticket 10 (Assigned) - Carpenter A (23)
(10, 7, 'Ticket raised: Classroom chair leg snapped.', '2026-01-19 07:50:00'),
(10, 29, 'Acknowledged. Assigned to Carpenter.', '2026-01-19 08:00:00'),
(10, 23, 'Update: Repairing chair frame and reinforcing joints; safety check pending.', '2026-01-19 09:00:00');
