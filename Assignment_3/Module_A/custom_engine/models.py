...
def storage_path_from_repo() -> str:
    # Storage path relative to Module_A
    # File: Assignment_3/Module_A/custom_engine/models.py
    # Target: Assignment_3/Module_A/custom_engine_state/
    module_a_dir = Path(__file__).resolve().parents[1]
    return str(module_a_dir / "custom_engine_state")
